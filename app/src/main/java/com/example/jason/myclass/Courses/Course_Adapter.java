...
public class Course_Adapter extends RecyclerView.Adapter<Course_Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.mTitle.setText(mDataset.get(position).courseName);
        holder.mLocation.setText(mDataset.get(position).courseLoc);
        holder.mSection.setText(mDataset.get(position).courseSec);
        holder.mTime.setText(mDataset.get(position).courseTime);
    ...
    public void dbItemRemove(int position){
        String CourseNum = mDataset.get(position).courseNum;
